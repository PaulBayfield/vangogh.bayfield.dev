...
export default function Header() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col gap-6 md:gap-0 md:flex-row justify-between items-center p-6 md:p-12">
        <motion.a
          href="#accueil"
          className="flex items-center gap-2 md:gap-6 hover:scale-105 transition duration-300"
        ...
        >
          ...
          />
          <span className="font-title text-white text-4xl md:text-6xl">
            VAN GOGH
          </span>
        </motion.a>

        <motion.nav
          className="flex gap-6 text-white font-title text-2xl md:text-4xl"
          initial={{ opacity: 0, x: 30 }}
          animate={{ opacity: 1, x: 0 }}
      ...
      <motion.div
        className="relative z-10 mt-auto p-6 flex justify-end"
      ...
      >
        ...
        >
          ...
          Champs de blé sous un ciel orageux
        </div>
      </motion.div>
    </header>
  );
